...
import { IOrderServices } from "../../../Application/Contracts/IOrderServices.application.contracts";
...
container.register<IOrderServices>(
  "IOrderServices",
  { useClass: OrderService }
);

container.register<IGatewayPort>(
  "IGatewayPort",
  { useClass: InfinitePayAdapter }
);
